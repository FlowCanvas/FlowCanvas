...
public class KanbanBoard extends JFrame {
   ...
   public KanbanBoard(UsersDto usersDto, ClientServer clientServer) {
      ...
      list_project.addMouseListener(new MouseAdapter() {
         ...
         public void mouseClicked(MouseEvent e) {
            ...
            if (e.getClickCount() == 2) {
               ...
               try {
                   clientServer.sendMessage("projectJoin:" + userId + "/" + projectId);
